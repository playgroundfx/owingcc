...
If you can't beat 'em, join 'em, right? Today we are going to discuss
"Market Makers", large institutions that provide liquidity to the
markets, and how we can use fractional disparity to profit from them.
